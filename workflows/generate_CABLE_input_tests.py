...
if __name__ == "__main__":
    ...
    for siteID in siteID_list:
        ...
        for fname in fname_list:
            ...
            averagemetcsv = "data/averagemet/"+siteID+"_"+forecast_date+"_rain.csv"
            ...
            # Define names
            ens = fname[-6:-4]
            out_fname = "data/CABLEInputs/tests/"+forecast_date+"/"+siteID+"/"+siteID+"_"+forecast_date+"_ens"+ens+"_met_test.nc"
            print(out_fname)
            if not os.path.exists("data/CABLEInputs/tests/"+forecast_date+"/"+siteID):
                os.makedirs("data/CABLEInputs/tests/"+forecast_date+"/"+siteID)
