...
GenerateMetData <- function(Site,forecast_date){
  ...
  # Load radiation data
  rad30 <- readTableNEON(
    dataFile=paste0("./NEONData/",forecast_date,"/SLRNR_30min.csv"),
    varFile=paste0("./NEONData/",forecast_date,"/variables_00023.csv"))
  ...
  tas30 <- readTableNEON(
    dataFile=paste0("./NEONData/",forecast_date,"/SAAT_30min.csv"),
    varFile=paste0("./NEONData/",forecast_date,"/variables_00002.csv"))
  ...
  wnd30 <- readTableNEON(
    dataFile=paste0("./NEONData/",forecast_date,"/2DWSD_30min.csv"),
    varFile=paste0("./NEONData/",forecast_date,"/variables_00001.csv"))
  ...
  # Load precip data
  ppt30 <- readTableNEON(
    dataFile=paste0("./NEONData/",forecast_date,"/THRPRE_30min.csv"),
    varFile=paste0("./NEONData/",forecast_date,"/variables_00006.csv"))
  ...
  # Load pressure data
  pre30 <- readTableNEON(
    dataFile=paste0("./NEONData/",forecast_date,"/BP_30min.csv"),
    varFile=paste0("./NEONData/",forecast_date,"/variables_00004.csv"))
  ...
  rh30 <- readTableNEON(
    dataFile=paste0("./NEONData/",forecast_date,"/RH_30min.csv"),
    varFile=paste0("./NEONData/",forecast_date,"/variables_00098.csv"))
